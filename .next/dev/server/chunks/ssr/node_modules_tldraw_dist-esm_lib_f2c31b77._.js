...
async function defaultHandleExternalUrlContent(editor, { point, url }, { toasts, msg }) {
    ...
    const position = point ?? (editor.inputs.shiftKey ? editor.inputs.currentPagePoint : editor.getViewportPageBounds().center);
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tldraw$2f$dist$2d$esm$2f$lib$2f$shapes$2f$bookmark$2f$bookmarks$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createBookmarkFromUrl"])(editor, {
        url,
        center: position
    });
    if (!result.ok) {
...
const TldrawImage = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["memo"])(function TldrawImage2(props) {
