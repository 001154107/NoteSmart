...
function fromScratch(shapeIdsQuery, store) {
    ...
    const sortedShapes = Array.from(shapeIds, (id)=>store.get(id)).sort(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$lib$2f$reordering$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sortByIndex"]);
...
class Editor extends (_a = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$eventemitter3$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], _getIsShapeHiddenCache_dec = [
   ...
   */ setTool(Tool, parent) {
        parent ??= this.root;
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tldraw$2f$utils$2f$dist$2d$esm$2f$lib$2f$object$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["hasOwnProperty"])(parent.children, Tool.id)) {
            throw Error(`Can't override tool with id "${Tool.id}"`);
        }
