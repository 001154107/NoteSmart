...
;
const TextDirection = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tldraw$2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Extension"].create({
    name: "textDirection",
    addGlobalAttributes () {
        return [
            {
...
;
;
const KeyboardShiftEnterTweakExtension = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tldraw$2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Extension"].create({
...
function renderHtmlFromRichText(editor, richText) {
    return htmlCache.get(richText, ()=>{
        ...
        const html = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tldraw$2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generateHTML"])(richText, tipTapExtensions);
...
function renderPlaintextFromRichText(editor, richText) {
    ...
    return plainTextFromRichTextCache.get(richText, ()=>{
        const tipTapExtensions = editor.getTextOptions().tipTapConfig?.extensions ?? tipTapDefaultExtensions;
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tldraw$2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generateText"])(richText, tipTapExtensions, {
            blockSeparator: "\n"
        });
    });
}
function renderRichTextFromHTML(editor, html) {
    const tipTapExtensions = editor.getTextOptions().tipTapConfig?.extensions ?? tipTapDefaultExtensions;
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tldraw$2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generateJSON"])(html, tipTapExtensions);
}
